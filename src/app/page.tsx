          ...
          if (card) {
            ...
            if (index === 1) {
              ...
              if (scrollProgress >= 0.5 && scrollProgress <= 0.7) {
                cardProgress = (scrollProgress - 0.5) / 0.2;
              ...
              if (scrollProgress >= 0.7) {
                cardProgress = (scrollProgress - 0.7) / 0.3;
              }
            }
          ...
          <div className="mb-10">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start space-x-3">
                          ...
                          <p className="text-gray-700 leading-relaxed">
                            Only 30% of African SMEs have meaningful
                            cybersecurity
                          </p>
                        </div>
                        <div className="flex items-start space-x-3">
            ...
            <div ref={securitySectionRef} className="relative w-full mb-16">
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-100">
                ...
                <div className="relative h-[800px] flex justify-center items-center perspective-1000">
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      Advanced antivirus with behavioral monitoring and
                ...
                {/* Security Stats */}
                <div className="mt-19 lg:mt-0 grid grid-cols-2 md:grid-cols-4 gap-6">
